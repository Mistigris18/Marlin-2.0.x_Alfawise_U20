...
#define STRING_CONFIG_H_AUTHOR "Mistigris" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "U20 Marlin2.0"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.22, 80.05, 398.85, 412.22 }
